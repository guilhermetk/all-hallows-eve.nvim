...
function M.apply()
	...
	vim.api.nvim_set_hl(0, "@function.method.call", { fg = p.red })
	vim.api.nvim_set_hl(0, "@function.method", { fg = p.fg1 })
	...
	vim.api.nvim_set_hl(0, "@type.definition", { fg = p.fg1, underline = true })
